...
# This function will output multiple files including CellType_CombinedSignedNegLogPValranksNormalized_DirwinHallPValues_Top_ProportionofTopDatasetNames_ofDatasetNames.txt, which includes p-values for all genes based on their reproducibility.
...
SumRank_GSEAPathways <- function(DatasetNames,BroadClusterTypes,SuffixofDifferentialExpressionOutput="",CommonGenes,ProportionofTopDatasetNames,PresenceofDataTable,directory,m_df_gene2term){
